...
| Keeping current (container freshness / canary) | IF-AVAILABLE | **yes** when the work asked to keep an image current and the chassis was copied (`adapters/github-azure.md`) | the rule tests | doctrine until then |
