...
Install when the work is to keep an image that already exists current. Not at
stand-up. A plan to host later is not that moment. This directory is not copied into
