...
4. `wiki/operating-model.md` — kinds of work for this project. If a Kinds of work
   **heading** is still `{{KIND_PLACEHOLDER}}`, filling it is the first task; do not
   start product edits first. Do not ask the owner to name jobs.
